...
class MobileNet(nn.Module):
    def __init__(self, decoder, output_size, in_channels=3, pretrained=True):
        ...
        self.output_size = output_size
        mobilenet = mobilenets.MobileNet()
        if pretrained:
            pretrained_path = os.path.join('/home/jinoo5953/FastDepth', 'results', 'model_best.pth.tar')
...
class MobileNetSkipAdd(nn.Module):
    def __init__(self, output_size, pretrained=True):
        ...
        mobilenet = mobilenets.MobileNet()
        if pretrained:
            pretrained_path = os.path.join('C:\\Users\\son\\Desktop\\FastDepth\\model', 'model_best.pth.tar')
